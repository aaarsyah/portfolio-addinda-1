      ...
      <div className="container relative z-10 px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          <div className="flex flex-col justify-center space-y-4 animate-fade-in">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-gray-600 md:text-xl">
                Crafting seamless mobile apps and stunning UI/UX designs. Let’s create something amazing together!
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              ...
              <Button variant="outline" size="lg" className="bg-white/50 hover:bg-white/70">
                <Link href="https://drive.google.com/uc?export=download&id=1plYgSXEqvSYQFf3bHY1YhvnbZQZlq7sM">
          ...
          <div className="flex items-center justify-center animate-scale-in animate-delay-300">
            ...
            <Image 
            src="https://drive.google.com/uc?export=view&id=1qI7QYyuER7XkeRth65l91ApYjMgMI-q-"
            alt="Profile"
            fill
            className="object-cover"
            priority
